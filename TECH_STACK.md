...
- **Data Extraction**: Headless `puppeteer-core` with strictly configured Chromium (`@sparticuz/chromium`) to render the X page, bypass initial load walls, and traverse the DOM dynamically for exact payload extraction.
